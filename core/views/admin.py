...
from ..services.renders import render_players, render_pairs, render_switch_players
...
def switch_players(request, uuid):
    ...
    return render(request, "match/partials/admin_switch_players.html", render_switch_players(session))
